...
public class AnthropicService {
    ...
    public String generateGregoryAnalysis(Map<String, Object> widgetData) {
        if (client == null) {
    ...
    private String buildPrompt(Map<String, Object> widgetData) {
        ...
        if (widgetData.containsKey("symbolsData")) {
            ...
            List<Map<String, Object>> symbolsData = (List<Map<String, Object>>) widgetData.get("symbolsData");
            prompt.append("Stock Performance:\n");
            for (Map<String, Object> stock : symbolsData) {
                prompt.append("- ").append(stock.get("symbol"))
                      .append(": Weekly ").append(stock.get("weeklyChange"))
                      .append(", YTD ").append(stock.get("ytdChange")).append("\n");
            }
        }
